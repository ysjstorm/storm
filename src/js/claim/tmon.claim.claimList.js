var claimClaimList = function(){
    this.init();
};

claimClaimList.prototype = {
    ...
    init : function(){
        ...
        this._oClaimListLoad = new claimListLoad(TMON.claim.htAPI.getClaimList, true);
    ...
    cacheElement : function(){
        ...
        this._welClaimList = $("#_claimList");
    },

    setEvent : function(){
        this._welClaimList.on("click", ".__link_detail_deal", $.proxy(this._onClickDetail, this));
    },
